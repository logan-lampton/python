...
cost = input("What would you like?: 'Espresso', 'Latte', or 'Cappuccino': ")
if cost == "Espresso":
    cost = espresso_cost
elif cost == "Latte":
    cost = latte_cost
...
amt_quarters = input("How many quarters?: ")
amt_dimes = input("How many dimes?: ")
amt_nickels = input("How many nickels?: ")
amt_pennies = input("How many pennies?: ")
